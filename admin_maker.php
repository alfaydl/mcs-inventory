...
<html>
	...
	<body>
		...
		<div class="main">
			<div class="isimain">
				<table>
					<a href="admin_input.php"><input type="submit" value="Membuat Request"></a>
					<hr>
					<h1>Request Data</h1>
					<hr>
					<tr>
					...
					<?php 
						...
						$data = mysqli_query($connect, "SELECT * FROM maker ORDER BY id_maker ASC");
					...
					?>
							<tr>
								...
								<td><?php echo $row['approvement']; ?></td>
					 			<td><a href="admin_edit_maker.php?id_maker=<?php echo $row['id_maker'];?>">EDIT</a>
								<a href="admin_hapus_maker.php?id_maker=<?php echo $row['id_maker'];?>">HAPUS</a></td>
					 		</tr>
					 		<?php $i++; ?>
						<?php
						}

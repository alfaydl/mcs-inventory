	...
	<div class="isimain">
		<span class="span">Input Data</span>
			...
			<table>
				...
				mysqli_query($connect,"UPDATE maker SET nama_maker='$nama_maker', request='$request', harga='$harga', jumlah='$jumlah', tanggal_request='$tanggal_request', keterangan='$keterangan' WHERE id='$id'");

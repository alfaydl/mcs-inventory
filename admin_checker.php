		...
		<div class="main">
			<div class="isimain">
				<table>
					...
					<?php
						$query = mysqli_query($connect, "SELECT * FROM maker ORDER BY id_maker ASC"); 
					...
					?>
							<tr>
								...
								<td><?php echo $row['approvement']; ?></td>
					 			<td><a href="admin_edit_checker.php?id_maker=<?php echo $row['id_maker'];?>">CHECKING</a>
							</tr>
							<?php $i++;?>
								<?php
							}

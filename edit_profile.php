...
<table>
				...
				<tr>
					<td>Level</td>
					<td><input type="text" disabled name="level" value="<?php echo $d['level']; ?>" ><br></td>
				</tr>			
			</table>
					...
					<?php 
						...
						mysqli_query($connect,"UPDATE user SET nama='$nama', username='$username', password='$password', email='$email' WHERE id='$id'");
					?>
